...
SYNONYMS: dict[str, str] = {
    ...
    "ns": "namespace 命名空间",
    "命名空间": "ns namespace",
    # pod trouble symptoms — extremely common SRE vocabulary that isn't
    # in any skill description but should surface pod diagnostic commands.
    "crashloop": "pod describe events logs diagnose restart 崩溃",
    "crashloopbackoff": "pod describe events logs diagnose restart",
    "崩溃": "crashloop describe events logs",
    "oom": "pod describe events logs memory killed",
    "oomkilled": "pod describe events logs memory",
    "imagepullbackoff": "pod describe events image pull",
    "imagepull": "pod describe events image",
    "evicted": "pod describe events node resource",
    "pending": "pod describe events schedule",
    "notready": "pod describe events node ready",
    "unhealthy": "pod describe events probe liveness readiness",
    "probe": "events describe unhealthy",
    "readiness": "probe describe events",
    "liveness": "probe describe events",
    "root": "cause reason diagnose 根因",
    "根因": "root cause diagnose describe events",
    # verbs / actions
