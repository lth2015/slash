...
class ContextResponse(BaseModel):
    ...
    selected_gitlab: str | None
    selected_gitlab_tier: Tier
...
def get_context() -> ContextResponse:
    ...
    return ContextResponse(
        ...
        selected_gitlab=sel.gitlab,
        selected_gitlab_tier=sel.gitlab_tier,
        drift_k8s=drift_seconds("k8s"),
        drift_aws=drift_seconds("aws"),
        drift_gcp=drift_seconds("gcp"),
        drift_gitlab=drift_seconds("gitlab"),
